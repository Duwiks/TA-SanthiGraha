...
class RekapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Hitung summary dari data yang disetujui setelah filter diterapkan (tanpa pagination)
    ...
    public function export(Request $request)
    {
        ...
        if ($request->filled('date_from'))
            $html .= '<tr><td>Dari Tanggal</td><td>: ' . \Carbon\Carbon::parse($request->date_from)->format('d M Y') . '</td></tr>';
        if ($request->filled('date_to'))
            $html .= '<tr><td>Sampai Tanggal</td><td>: ' . \Carbon\Carbon::parse($request->date_to)->format('d M Y') . '</td></tr>';
        $html .= '</table>';
