        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-5 mb-8 pb-6 border-b border-slate-100 border-dashed">
                    <div class="w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500 to-teal-400 flex items-center justify-center text-white font-bold text-3xl shadow-lg shadow-emerald-500/20">
                        {{ strtoupper(substr($user->name, 0, 1)) }}
                    </div>
                    <div>
                        <h4 class="text-xl font-bold text-slate-800">{{ $user->name }}</h4>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 mt-1.5 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-600 border border-emerald-200 capitalize">
