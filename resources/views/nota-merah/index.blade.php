            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-4">
                        ...
                        @if($nota->description)
                            <div class="text-[12px] text-slate-400 mt-1 italic">{{ Str::limit($nota->description, 50) }}</div>
                        @endif
                    </td>
                    <td class="px-5 py-4 whitespace-nowrap">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-16 text-center">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Klik tombol "Ajukan Nota Merah" untuk memulai pengajuan dana.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
...
<div class="mt-5 flex flex-wrap gap-3 text-xs text-slate-500">
    ...
    <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-amber-400 inline-block"></span> Ajukan</span>
    <i class="ph ph-arrow-right text-slate-300"></i>
    <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-blue-400 inline-block"></span> Disetujui Admin</span>
    <i class="ph ph-arrow-right text-slate-300"></i>
    <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-purple-400 inline-block"></span> Upload Realisasi</span>
    <i class="ph ph-arrow-right text-slate-300"></i>
    <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-emerald-400 inline-block"></span> Dikonfirmasi → Kas</span>
</div>
@endsection
