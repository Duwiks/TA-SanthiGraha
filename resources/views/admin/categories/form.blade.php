            ...
            <div class="p-6 md:p-8">
                <form
                    ...
                    <div class="space-y-5">
                        <!-- Nama Kategori -->
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1.5">Nama Kategori <span
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all resize-none"
                    ...
                    <div class="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 hover:shadow-lg hover:shadow-emerald-500/20 transition-all text-white rounded-xl text-sm font-semibold shadow-lg shadow-brand-500/30 flex items-center gap-2">
