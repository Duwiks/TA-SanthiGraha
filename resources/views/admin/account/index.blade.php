        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-5 mb-8 pb-6 border-b border-slate-100 border-dashed">
                    <div
                        class="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-3xl shadow-lg shadow-indigo-500/20">
                        {{ strtoupper(substr($user->name, 0, 1)) }}
                    </div>
                    <div>
                        <h4 class="text-xl font-bold text-slate-800">{{ $user->name }}</h4>
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 mt-1.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-600 border border-indigo-200 capitalize">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="bg-slate-50 rounded-xl p-4 border border-slate-100">
                        ...
                        <p class="text-sm font-semibold text-slate-800">
                            {{ $user->created_at ? $user->created_at->format('d M Y, H:i') : '-' }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            Swal.fire({
                ...
                html: `
                        <div style="text-align:left; margin-top:8px;">
                            ...
                            <p style="font-size:12px;color:#94a3b8;margin-top:12px;"><i class="ph ph-info" style="margin-right:4px;"></i>Lupa password lama? Silakan hubungi developer untuk reset password.</p>
                        </div>
                    `,
