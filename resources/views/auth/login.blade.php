...
@section('content')
    ...
    <div class="text-center mt-8 text-sm text-slate-500 font-medium">
        Belum punya akun pegawai? <a href="{{ url('/register') }}"
            class="text-brand-600 hover:text-brand-700 hover:underline font-semibold transition-colors">Daftar di sini</a>
    </div>
